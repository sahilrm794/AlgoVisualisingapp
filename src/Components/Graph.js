            ...
            <>
                ...
                <div className="container" style={{ alignItems: "center", justifyContent: "center" }}>
                    <nav className="navbar navbar-expand-lg navbar-dark bg-dark" style={{ borderRadius: "0px 0px 10px 10px", height: "75px" }}>
                        ...
                        {this.state.addingEdge && <input style={{ width: "80px", margin: "5px" }} id='edgeInput1' type="number" placeholder='From'/>}
                        {this.state.addingEdge && <input style={{ width: "80px", margin: "5px" }} id='edgeInput2' type="number" placeholder='To'/>}
                        {this.state.addingEdge===1 && <input style={{ width: "80px", margin: "5px" }} id='edgeInput3' type="number" placeholder='Weight'/>}
